...
class TipySpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        if title is not None:
            ...
            items['rating_5_star'] = convert(product_review_rating_5_star),
            items['rating_4_star'] = convert(product_review_rating_4_star),
            items['rating_3_star'] = convert(product_review_rating_3_star),
            items['rating_2_star'] = convert(product_review_rating_2_star),
            items['rating_1_star'] = convert(product_review_rating_1_star),
            items['platform'] = 'tiki'
